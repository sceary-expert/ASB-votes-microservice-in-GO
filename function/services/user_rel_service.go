...
import (
	...
	coreData "example.com/core/data"
	repo "example.com/core/data"
	"example.com/core/data/mongodb"
	mongoRepo "example.com/core/data/mongodb"
	"example.com/core/pkg/log"
	"example.com/core/utils"
	dto "example.com/function/dto"
...
func (s UserRelServiceImpl) FindRelsIncludeProfile(filter interface{}, limit int64, skip int64, sort map[string]int) ([]dto.UserRel, error) {
	...
	unwindLeftUser["$unwind"] = "$leftUser" //how? how string "$leftUser" can be used as an interface
